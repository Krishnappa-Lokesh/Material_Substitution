sap.ui.define([
	...
	return BaseController.extend("matsubs.controller.Worklist", {
...
/*			this._oTPC = new TablePersoController({
				table: this.getView().byId("materialSubstitutionTable"),
				//specify the first part of persistence ids e.g. 'demoApp-productsTable-dimensionsCol'
				componentName: "matsubs",
...
*/			
		...
		onSearch: function(oEvent) {
			if (oEvent.getParameters().refreshButtonPressed) {
				...
				if (sQuery && sQuery.length > 0) {
					oTableSearchState = [new Filter("FrMaktx", FilterOperator.Contains, sQuery)];
				}
		...
		_showObject: function(oItem) {
			var oContext = oItem.getBindingContext();
				var sFrMatnr = oContext.getProperty("FrMatnr");
				var sToMatnr = oContext.getProperty("ToMatnr");
				var sSpWerks = oContext.getProperty("SpWerks");
				var sDeWerks = oContext.getProperty("DeWerks");
		...
		onNewButtonPressed: function() {
			this.getRouter().navTo("createMatSubs");
